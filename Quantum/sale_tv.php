...
<body>
<form action="sale_tv.php" method="post" enctype="multipart/form-data">
<table align="center">
<tr>
<td>
	<ul class="menu cf">
...
<table align="center" cellpadding="15">
	...
	<?php
		$select="SELECT * FROM product WHERE category_category_id = 'C-5cc055af84256'";
	$run=mysqli_query($mysqli,$select);;
	$count7=mysqli_num_rows($run);

	for($i=0;$i<$count7;$i+=3)
	{
		$select1="SELECT * FROM product WHERE category_category_id = 'C-5cc055af84256'
